...
from Ejemplo3 import clock
video = cv2.VideoCapture('GOPR0656.MP4')
ejex_rojo=[]
ejex_azul =[]
ejey_rojo=[]
ejey_azul =[]
...
#########################encontrando el mayor contorno#####################33333
l=0
...
# video = cv2.VideoCapture('GOPR0653.mp4')


############# Metodo nuestro para cada frame del video ###########################################
while(1):
     ret, frame = video.read()
